...
combo box. The user will the select an option from the second combo box and the table will populate with the correct information.

Description of report: The user option in reports will show all appointments made be the selected user.
